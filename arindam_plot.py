...
plt.errorbar(sat_axis,sat_obs,yerr=error_obs,fmt="*",ls="-",label="Observation_signal")     
plt.xscale('log')
plt.yscale('log')
...
#plt.ylim(-50, 180) 
#plt.axhline(0,ls="--")
#plt.title("Observation Signal for Arindam")

    
plt.savefig("loglog_with_errorbars.png")
plt.show()
