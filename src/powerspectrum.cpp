...
double cosmology::wpnl(double z, double rad,double projmax){
    ...
    if (stat!=0){
        fprintf(stderr, "Integration issue in wpnl\n");
    }
    gsl_integration_workspace_free (w);
...
double cosmology::wpl(double z, double rad, double projmax){
    ...
    if (stat!=0){
        fprintf(stderr, "Integration issue in wpl\n");
    }
...
double cosmology::xiNL_bar(double r,double z){
    ...
    if (stat!=0){
        fprintf(stderr, "Integration issue in xiNL_bar\n");
    }
    return result*3.;
}
...
double cosmology::xiNL_barbar(double r,double z){
    ...
    if (stat!=0){
        fprintf(stderr, "Integration issue in xiNL_barbar\n");
    }
        return result*5.;
}
...
double cosmology::wpnl_kaiser(double z, double rad, double projmax,double fkai){
    ...
    if (stat!=0){
        fprintf(stderr, "Integration issue in wpnl_kaiser\n");
    }
...
double cosmology::xiL_bar(double r,double z){
    ...
    if (stat!=0){
        fprintf(stderr, "Integration issue in xiL_bar\n");
    }
...
double cosmology::xiL_barbar(double r,double z){
    ...
    if (stat!=0){
        fprintf(stderr, "Integration issue in xiL_barbar\n");
    }
        return result*5.;
}
...
double cosmology::wpl_kaiser(double z, double rad, double projmax,double fkai){
    ...
    if (stat!=0){
        fprintf(stderr, "Integration issue in wpl_kaiser \n");
    }
        result=2.0*rad*result;
        //exit(1111);
        return result;
